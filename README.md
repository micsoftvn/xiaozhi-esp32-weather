# Xiaozhi ESP32 Weather Edition

基于原版 [xiaozhi-esp32](https://github.com/78/xiaozhi-esp32) 的天气增强版本

（中文 | [English](README_en.md) | [日本語](README_ja.md)）

## 介绍

**版本**: v1.0.3 Weather Edition - 增强天气显示功能
...
#### 🌤️ Weather Edition 新增功能
- **增强天气显示界面** - 优化的天气信息展示
- **实时天气面板** - 显示时间、温度、湿度信息
- **改进的待机界面** - 更好的天气数据布局
- **代码结构优化** - 清理项目结构，提高可维护性
